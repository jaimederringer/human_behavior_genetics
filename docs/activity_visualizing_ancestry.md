...
**Step 2:** In the left-side console area, paste the following code and hit enter to import two datasets from the web and save them to datasets named 'PCs_NL' (the genomic principal components) and 'province' (a key for which participants live where):
...
**Step 4:** Look at some distributions of the variables:
...
**Step 5:** Merge the two datasets so you have both the principal components and province information in a single dataset:
...
**Step 6:** Rename the variables to be easier to read/remember:
...
**Step 5:** Define color coding based on province location for the plot (you can copy and paste this whole chunk at one time):
...
**Step 6:** Visualize individuals by a plot of PC1 along the x-axis and PC2 along the y-axis:
...
**Step 7:** Change something about the plot (the colors, or choose different PCs for the x- and/or y-axis, or the size/shape of the individual dots; something to show that it's not a screengrab of the existing image :) and save the resulting plot by clicking the Export button at the top of the plotting window. 

## Submission Instructions

Upload the MODIFIED plot that you created in **Step 7** to Moodle for credit on this activity.