...
# Psyc 408, Human Behavior Genetics, Fall 2019

Tuesdays 11:00 am - 12:20 pm in 32 Psychology

Instructor: **Jaime Derringer, jderr@illinois.edu**
...
![](http://www.quickmeme.com/img/09/09477172619189fbe2b0a74b603e17b99a5b0024c33ccdc336f0b4da5130bb76.jpg)
...
* Draft bibliography (5%): A list of at least 5 primary research articles related to your topic.
* Annotated bibliography (15%): Summaries of at least 10 primary research articles related to your topic.
* Paper draft (10%): Evaluated on topic coverage, reference variety, organization, and grammar.
* Blog post (5%): Draft and final versions, before and after in-class peer review.
* Peer reviews (5%): Provide structured, journal-style feedback on 2 others’ papers.
* Final paper (10%): Evaluated on topic coverage, organization, grammar, APA formatting, and responsiveness to reviewer comments.
...
Assigned readings that are publicly available are linked directly from this site. Assigned readings that are only available behind a paywall (:closed_lock_with_key:) are posted for students on the UIUC-login-required course site at https://compass2g.illinois.edu/. 
...
**Goal:** Introduce the logic and history for behavior genetics. Focus on (1) logic of why we study genetic influences on human behavior, (2) introducing concerns about ethical application of genetic knowledge, and (3) considering issues of research quality in drawing conclusions about important topics.

**Readings**
* Caspi, A., Sugden, K., Moffitt, T. E., Taylor, A., Craig, I. W., Harrington, H., ... & Poulton, R. (2003). Influence of life stress on depression: moderation by a polymorphism in the 5-HTT gene. _Science_, _301_(5631), 386-389. https://doi.org/10.1126/science.1083968 :closed_lock_with_key:
* Border, R., Johnson, E. C., Evans, L. M., Smolen, A., Berley, N., Sullivan, P. F., & Keller, M. C. (2019). No support for historical candidate gene or candidate gene-by-interaction hypotheses for major depression across multiple large samples. _American Journal of Psychiatry_, _176_(5), 376-387. [https://doi.org/10.1176/appi.ajp.2018.18070881](https://doi.org/10.1176/appi.ajp.2018.18070881) :unlock:
* Alexander, S. (7 May 2019). 5-HTTLPR: A pointed review. Slate Star Codex. [https://slatestarcodex.com/2019/05/07/5-httlpr-a-pointed-review/] :unlock:(https://slatestarcodex.com/2019/05/07/5-httlpr-a-pointed-review/)
...
**Activity:** (Thursday) Quickdraw Reference Search
...
**Assignment due:** Draft bibliography [5 points] (Thursday September 19)

--------

### <a id="week-5"></a>Week 5: Core Topics

**Activity:** Topic Roulette I
...
:star: Find a [@SbotGwa tweet](https://twitter.com/sbotgwa) relevant to your phenotype.

**Assignment due:** Annotated bibliography [15 points] (Thursday October 17)
...
**Activity:** Find a popular press report of behavior genetics research and track down the original empirical paper to which it referred. Compare & critique.
...
**Assignment due:** Paper draft [10 points] (Thursday November 7)
...
### <a id="week-14"></a>Week 14: Discussion: [Genetics at Trial](https://jaimederringer.github.io/psyc408/activities.md#genetics-at-trial)
...
**Assignment due:** [Peer review](https://jaimederringer.github.io/psyc408/activities.md#peer-review) [5 points] (Thursday December 5)

--------

### <a id="week-15"></a> Week 15: Wrap Up

**Assignments due:** [Genetics at Trial reflection](https://jaimederringer.github.io/psyc408/activities.md#genetics-at-trial-reflection-essay) [5 points] (Tue Dec 10); [Final paper](https://jaimederringer.github.io/psyc408/activities.md#final-paper) [10 points] (TBD)
